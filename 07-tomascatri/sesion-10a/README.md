...
Indagaron en los capitulos del libro y reflexionaron sobre esto, como aun no me lo leo no estuve tan atento pero me llamo la atencion lo que dijieron sobre como nuestro imaginario son posibles construirlos desde fuera y como nosotrros lo constrruimos a partir de eso 

## apuntes en la charla

* El proyecto comenzó en 2022 a partir de la intersección y encuentro de dos personas.
...
* Hasta la fecha han realizado 7 proyectos en distintos lugares. La obra cambia y se transforma a través del diálogo con diferentes artistas y colaboradores locales, incorporando performances en algunas de sus estancias.
* Cada exposición es una nueva versión expandida de la propuesta. El proyecto se adapta a los contextos específicos de cada lugar y el colectivo aprende continuamente a través de este proceso.

### Publicaciones
* **Publicaciones expandidas:** Por cada exposición generan publicaciones para compartir los pensamientos y las miradas de quienes se suman al proyecto. Buscan expandir el concepto tradicional de "publicación", incluyendo formatos como el *flexidisk* (disco de vinilo flexible), fotos y textos.
* A través de este proceso continuo de muestras y colaboraciones, lo que están construyendo formalmente es un archivo del proyecto.
...
* A esta recopilación se le conoce como **nube de puntos**. El mundo real es continuo, pero este registro es inherentemente discontinuo (fragmentado). Aunque da la sensación de que los rayos pueden ver el interior de los objetos, en realidad solo capturan la superficie exterior donde rebota el láser.

### Concepto
* Les interesa aplicar este escaneo a la naturaleza, específicamente a un árbol de más de 300 años de antigüedad. En lugar de verlo como un objeto sólido, lo interpretan como una red viva que se adapta constantemente a su entorno.
